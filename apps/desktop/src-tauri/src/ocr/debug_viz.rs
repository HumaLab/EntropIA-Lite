...
//!     bounding boxes drawn on top for OCR debugging.
...
/// Color for OCR line detection bounding boxes.
...
///
/// This is the OCR debug equivalent of `vis_result.jpg` — each detected text
